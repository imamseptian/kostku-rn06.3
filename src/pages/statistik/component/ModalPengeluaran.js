...
import OutcomeSVG from '../../../asset/image/outcome.svg';
import {ModalItemPembayar} from '../atom';
import axios from 'axios';

const ModalPengeluaran = ({data, closeModal, ...rest}) => {
  ...
  const DaftarTransaksi = () =>
    dataTransaksi.map((item, index) => {
      return <ModalItemPembayar data={item} title={item.judul} key={index} />;
    });
